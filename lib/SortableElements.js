...
var SortableItems = /*#__PURE__*/function (_Component) {
  ...
  _createClass(SortableItems, [{
    ...
    value: function sortData(from, to) {
      ...
      var onChange = this.props.onChange || function (items) {
        return null;
      };
    ...
    value: function dragEnd(e) {
      ...
      var from = Number(this.dragged.dataset.ind);
      var to = Number(this.over.dataset.ind);
      if (from < to) to--;
    ...
    value: function dragOver(e) {
      ...
      var relY = this.dragged.offsetTop - this.over.offsetTop;
